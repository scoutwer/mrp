...
class ReactiveMRPApp:
    ...
    def build_ui(self):
        ...
        ttk.Label(main_container, text="Interaktywny System MRP", style="Header.TLabel").pack(anchor="w", pady=(0, 10))
    ...
    def zapisz_historie_do_pliku(self):
        try:
            ...
            messagebox.showerror("Błąd zapisu", f"Nie udało się trwale zapisać historii do pliku:\n{e}")
    ...
    def usun_z_historii(self):
        ...
        if messagebox.askyesno("Potwierdzenie", f"Czy usunąć '{nazwa}' z zapisanej bazy?"):
            if messagebox.askyesno("Ostateczne usunięcie", "Czy napewno chcesz usunąć ten produkt?"):
